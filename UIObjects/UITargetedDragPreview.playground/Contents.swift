...
class ViewController: UIViewController {
    ...
    var imageView: UIImageView! // Declare viewToDrag as a property
    
    override func viewDidLoad() {
        super.viewDidLoad()
        
        imageView = UIImageView(image: .init(systemName: "heart"))
        imageView.frame = .init(x: 50, y: 150, width: 100, height: 100)
